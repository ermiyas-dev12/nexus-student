...
def register_main_routes(app):
    ...
    def community():
        ...
        if query:
            posts = (
                Post.query.filter(Post.title.ilike(f"%{query}%") | Post.body.ilike(f"%{query}%"))
        ...
        return render_template("community.html", posts=posts, query=query, liked_post_ids=liked_post_ids)
