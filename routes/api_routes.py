...
def register_api_routes(app):
    ...
    def chat_history():
        ...
        return jsonify(
            [
                {"message": h.message, "response": h.response, "created_at": h.created_at.strftime("%b %d, %H:%M")}
    ...
    def search_posts():
        ...
        posts = (
            Post.query.filter(db.or_(Post.title.ilike(f"%{query}%"), Post.body.ilike(f"%{query}%")))
